...
import MembraneDetails from "./MembraneDetails";
import Data from "./membrane.json";
...
const Membranepage = () => {
  ...
  return (
    ...
    <div className="flex justify-left mx-10 ">
      {selectedProtein ? (
        <MembraneDetails membrane={selectedProtein} onBack={handleBackClick} />
      ) : (

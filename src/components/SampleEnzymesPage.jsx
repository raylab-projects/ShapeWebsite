                        ...
                        <div className="relative max-w-xs">
                           ...
                           <table className='table bg-gray-600 '>
                            ...
                            <tbody className="divide-y divide-gray-200">
                              {records.map((item) => (
                                <tr>
                                  <td className="px-6 py-4 text-sm text-gray-100 whitespace-nowrap">{item.serial}</td>
                                  <td className="px-6 py-4 text-sm text-gray-100 whitespace-nowrap">{item.pdb}</td>
                                  <td className="px-6 py-4 text-sm text-gray-100 whitespace-nowrap">{item.protein}</td>
                                </tr>
                              )
                              )}
                            </tbody>
      ...
      <nav>
        <ul className='pagination'>
          <li className="page-item">
            <a href ='#' className='page-link font-bold text-gray-100' onClick={prePage}>Prev</a>
          </li>
          {
            numbers.map((n,i) => (
          ...
          <li className='page-item'>
            <a href ='#' className='page-link font-bold text-gray-100' onClick={nextPage}>Next</a>
          </li>
        </ul>
      </nav>
    </div>
...
export default SampleEnzymespage